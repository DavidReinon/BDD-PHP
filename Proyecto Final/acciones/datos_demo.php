...
if (!$error) echo "Datos en tabla alumnos insertados correctamente <br><br>";
...
(3, '2018-10-04', '12:00:00', 'A1', 'Sociales', '33333333C'),
(4, '2018-10-04', '13:00:00', 'A5', 'Naturales', '44444444D'),
...
(8, '2020-11-09', '17:00:00', 'A2', 'Valenciano', '88888888H'),
(9, '2020-12-31', '18:00:00', 'A1', 'Ingles', '99999999I'),
(10, '2021-04-03', '19:00:00', 'B1', 'Sociales', '00000000J'),
(11, '2021-05-15', '10:00:00', 'A2', 'Castellano', '11111111A'),
...
if (!$error) echo "Datos en tabla clases insertados correctamente <br><br>";
