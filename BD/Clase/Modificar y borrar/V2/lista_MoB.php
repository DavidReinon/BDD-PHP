...
<body>
  <p>Listado de piezas</p>
  <form id="form1" name="form1" method="post" action="MoB_producto.php">
    <p>
      <label for="listado">Listado Productos:</label>
    ...
    <p><input type="radio" name="seleccion" id="Borrar" value="Borrar">
